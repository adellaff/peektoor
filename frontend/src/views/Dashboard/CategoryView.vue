<template>
    <div class="h-96 bg-gray-100 p-4 rounded-lg shadow-md min-h-full min-w-full flex flex-col">
      <div class="p-5 bg-white p-4 rounded-lg shadow-md min-h-full min-w-full">
        ...
        <div class="m-3 ">
          <table class="flex flex-col justify-between overflow-y-auto min-w-full text-left min-w-full">
      ...
      <div class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50" v-show="isModalOpen" @click="closeModal">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
          ...
          <div class="mt-4">
            ...
            <input type="text" v-model="editedCategory.name" class="border border-gray-300 rounded-md p-2 w-full" placeholder="Category Name">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
          ...
          <div class="mt-4">
            ...
            <div class="flex justify-end">
                <button @click="deleteCategory" class="mt-4 mr-5 bg-red-500 text-white px-4 py-2 rounded-md">Yes</button>
  ...
  export default {
    ...
    methods: {
      openEditModal(index) {
        this.editedCategory = { ...this.category[index] };
        this.isModalOpen = true;
      },
      saveEdit() {
        // Implement save functionality here
        // For example, update the category in the array
        // this.category[this.editedCategory.id - 1] = this.editedCategory;
        this.closeModal();
      },
      closeModal() {
        this.isModalOpen = false;
        this.editedCategory = { id: null, name: "" };
      },
