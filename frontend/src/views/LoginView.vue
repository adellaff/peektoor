<template>
    <div class="flex h-screen items-center justify-center">
        <div class="main bg-black rounded-lg shadow-md p-10 transition-transform w-96 text-center">
            <h1 class="font-noto text-white text-3xl font-comic-sans">
            ...
            <form action="">
             ...
             text-gray-700 font-bold">Password:</label>
                ...
                <div class="flex justify-center items-center">
                    <button type="submit"
                        class="bg-white text-black py-2 px-6 rounded-md cursor-pointer transition-colors duration-300 hover:bg-gray-400">
                ...
                <div class="flex justify-center items-center">
                    <button type="submit"
                        class="flex items-center bg-white text-black py-2 px-6 rounded-md cursor-pointer transition-colors duration-300 hover:bg-gray-400">
                        ...
                        <IconGoogle class="w-10 me-2" />
                        Login With Google
                        <!-- <IconGoogle :iswhite="true"/> -->
                    </button>
                </div>
            </form>
            <p class="mt-4">
                <!-- <BeakerIcon class="size-100 text-red-500" />  -->
